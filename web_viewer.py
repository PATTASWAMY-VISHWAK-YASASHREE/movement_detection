...
<div class="row mb-4">
    <div class="col-12">
        ...
        <p class="text-muted">Motion detection alerts and captured images</p>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-6 col-lg-4 mb-4">
        <div class="card alert-card h-100">
            {% if alert[7] %}  <!-- image_id -->
            <img src="{{ url_for('view_image', image_id=alert[7]) }}" 
...
<nav aria-label="Page navigation">
    <ul class="pagination justify-content-center">
        ...
        <li class="page-item">
            <a class="page-link" href="?page={{ pagination.page - 1 }}&per_page={{ pagination.per_page }}&type={{ filters.type }}&date_from={{ filters.date_from or '' }}&date_to={{ filters.date_to or '' }}">Previous</a>
        </li>
        {% endif %}
        ...
        <li class="page-item">
            <a class="page-link" href="?page={{ page_num }}&per_page={{ pagination.per_page }}&type={{ filters.type }}&date_from={{ filters.date_from or '' }}&date_to={{ filters.date_to or '' }}">{{ page_num }}</a>
        </li>
        ...
        <li class="page-item">
            <a class="page-link" href="?page={{ pagination.page + 1 }}&per_page={{ pagination.per_page }}&type={{ filters.type }}&date_from={{ filters.date_from or '' }}&date_to={{ filters.date_to or '' }}">Next</a>
        </li>
        {% endif %}
    </ul>
</nav>
...
def main():
    ...
    print("🌐 Motion Detection Web Viewer")
    print("=" * 50)
