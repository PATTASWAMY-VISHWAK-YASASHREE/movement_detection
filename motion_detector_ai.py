#!/usr/bin/env python3
"""
Motion Detection Security System with AI Object Recognition

A real-time security system that uses computer vision to detect motion
and AI to identify objects for enhanced security alerts.
...
- D: Toggle detection display mode
- Q: Quit application
...
class MotionDetectionSystem:
    ...
    def run(self):
        ...
        try:
            while self.running:
                ...
                # Display frame
                cv2.imshow('Motion Detection Security System with AI', frame)
    ...
    def show_help(self):
        ...
        if self.object_detector.detection_enabled:
            print("\nDetectable Objects:")
            print("  🔴 High Priority: person")
            print("  🟠 Medium Priority: car, truck, motorcycle")
            print("  🟡 Low Priority: bicycle, dog, cat, bird")
            print("  🟢 Others: 75+ everyday objects")
...
def main():
    """Main entry point"""
    print("🚀 Starting Motion Detection Security System with AI...")
